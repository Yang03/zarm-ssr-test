...
function (_PureComponent) {
  ...
  function NoticeBar() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(NoticeBar)).call.apply(_getPrototypeOf2, [this].concat(args)));
    _this.wrapper = null;
    _this.content = null;
    _this.state = {
      animationDuration: 0
  ...
  _createClass(NoticeBar, [{
    ...
    value: function render() {
      ...
      return React.createElement(Message, _extends({}, others, {
        size: "lg"
