...
function (_PureComponent) {
  ...
  _createClass(NoticeBar, [{
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 5;
              return _regeneratorRuntime.awrap(asyncWrapper);

            case 5:
              wrapperWidth = _context.sent;
              _context.next = 8;
              return _regeneratorRuntime.awrap(asyncContent);
    ...
    value: function render() {
      ...
      return React.createElement(Message, _extends({}, wrapperProps, others, {
        size: "lg"
