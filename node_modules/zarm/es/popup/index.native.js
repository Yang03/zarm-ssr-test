...
import { StyleSheet, View, UIManager, Animated, Easing } from 'react-native';
import popupStyle from './style/index.native'; // import Mask from '../Mask';

var popupStyles = StyleSheet.create(popupStyle);
...
function (_PureComponent) {
  ...
  function Popup(props) {
    ...
    _this.onLayout = function (e, direction, that) {
      var directionStyle = {};
      UIManager.measure(e.target, function (_x, _y, width, height) {
