...
function (_PureComponent) {
  ...
  function Portal(props) {
    ...
    _this.renderMask = function () {
      ...
      return mask && React.createElement(Mask, {
        className: maskCls,
        style: maskStyle,
        visible: true,
        type: maskType
    ...
    _this.getComponent = function () {
      ...
      return React.createElement(React.Fragment, null, _this.renderMask(), React.createElement("div", {
        role: "dialog",
    ...
    _this.renderPortal = function () {
      ...
      return ReactDOM.createPortal(_this.getComponent(), _this._container);
    };
