...
function (_React$Component) {
  ...
  _createClass(Popper, [{
    ...
    value: function render() {
      ...
      var child = React.isValidElement(children) ? children : React.createElement("span", null, children);
      ...
      var toolTip = React.createElement(ClickOutside, {
      ...
      }, content), hasArrow && React.createElement("span", {
        className: "".concat(prefixCls, "__arrow"),
        ref: function ref(el) {
          _this2.arrowRef = el;
        }
      })));
      return React.createElement(React.Fragment, null, mounted && createPortal(toolTip, this.mountContainer()), React.cloneElement(child, _objectSpread({
        ref: function ref(node) {
