...
function (_PureComponent) {
  ...
  _createClass(Tabs, [{
    ...
    value: function render() {
      ...
      if (swipeable) {
        contentRender = React.createElement(Carousel, {
          swipeable: !disabled,
        ...
        contentRender = React.Children.map(children, function (item, index) {
          return item.props.children && React.createElement(TabPanel, _extends({}, item.props, {
      ...
      if (lineWidth) {
        ...
        lineInnerRender = React.createElement("span", {
      ...
      }, tabsRender, React.createElement("div", {
        className: "".concat(prefixCls, "__line"),
        style: lineStyle
      }, lineInnerRender))), React.createElement("div", {
