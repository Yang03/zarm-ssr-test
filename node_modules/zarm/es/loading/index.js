...
function (_PureComponent) {
  ...
  _createClass(Loading, [{
    ...
    value: function render() {
      ...
      }, content || React.createElement(ActivityIndicator, {
        type: "spinner",
        size: "lg"
      }))));
    }
...
Loading.show = function (content) {
  ...
  if (Loading.zarmLoading) {
    ...
    ReactDOM.render(React.createElement(Loading, props), Loading.zarmLoading);
  }
};

Loading.hide = function () {
  if (Loading.zarmLoading) {
    ReactDOM.render(React.createElement(Loading, {
      visible: false
    }), Loading.zarmLoading);
  }
};
...
Loading.unmountNode = function () {
  ...
  if (zarmLoading) {
    ReactDOM.render(React.createElement(React.Fragment, null), zarmLoading);
