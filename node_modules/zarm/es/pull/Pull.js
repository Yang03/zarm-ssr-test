...
function (_PureComponent) {
  ...
  function Pull(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Pull).call(this, props));
    _this.pull = void 0;
    _this.wrap = void 0;
    ...
    _this.addScrollEvent = function () {
      ...
      Events.on(scroller, 'scroll', _this.throttledScroll);
    };
      ...
      switch (refreshState) {
        case REFRESH_STATE.pull:
          return React.createElement("div", {
            ...
            loading: false,
            percent: percent
          }), React.createElement("span", null, locale.pullText));
        ...
        case REFRESH_STATE.drop:
          return React.createElement("div", {
            ...
            loading: false,
            percent: 100
          }), React.createElement("span", null, locale.dropText));
        ...
        case REFRESH_STATE.loading:
          return React.createElement("div", {
            ...
            type: "spinner"
          }), React.createElement("span", null, locale.loadingText));
        ...
        case REFRESH_STATE.success:
          return React.createElement("div", {
            ...
            type: "right-round",
            theme: "success"
          }), React.createElement("span", null, locale.successText));
        ...
        case REFRESH_STATE.failure:
          return React.createElement("div", {
            ...
            type: "wrong-round",
            theme: "danger"
          }), React.createElement("span", null, locale.failureText));
    ...
    _this.renderLoad = function () {
      ...
      switch (loadState) {
        ...
        case LOAD_STATE.complete:
          return React.createElement("div", {
            className: cls
          }, React.createElement("span", null, locale.completeText));
  ...
  _createClass(Pull, [{
    ...
    value: function render() {
      ...
      }, this.renderRefresh()), React.createElement("div", {
