...
function (_PureComponent) {
  ...
  function SwipeAction(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(SwipeAction).call(this, props));
    _this.isOpen = false;
    _this.touchEnd = true;
    ...
    _this.renderButton = function (button, index) {
      return cloneElement(button, {
        key: +index,
        styles: _objectSpread({}, button.props.styles, {}, StyleSheet.create({
  ...
  _createClass(SwipeAction, [{
    ...
    value: function render() {
      ...
      return left || right ? React.createElement(View, {
        style: styles.wrapper
      }, this.renderButtons(left, 'left'), this.renderButtons(right, 'right'), React.createElement(Animated.View, _extends({
