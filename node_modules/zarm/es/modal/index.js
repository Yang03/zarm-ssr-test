...
function modalType(props, type) {
  ...
  function render(visible) {
    var runTimeLocale = getRunTimeLocale();
    ...
    if (type === 'alert') {
      ...
      ReactDOM.render(React.createElement(Alert, _extends({}, _props, {
      ...
      ReactDOM.render(React.createElement(Confirm, _extends({}, _props2, {
        mountContainer: container,
        onCancel: function onCancel() {
          _onCancel(render);
        },
