...
export default memo(function (_ref) {
  var _ref$prefixCls = _ref.prefixCls,
      prefixCls = _ref$prefixCls === void 0 ? 'za-stackpicker' : _ref$prefixCls,
  ...
  var handleObtainItem = useCallback(function (list, _value) {
  ...
  var columnDataList = useMemo(function () {
    var group = [];
  ...
  return React.createElement(Popup, {
  ...
  }, React.createElement("p", null, "\u9009\u62E9\uFF1A", handleDisplayRender()), errorMsg && React.createElement("p", {
    ...
    var columnClass = classNames("".concat(prefixCls, "__stack-column"), 'za-stack-picker-stack-column', _defineProperty({}, "".concat(prefixCls, "__stack-column--hidden"), !currentValue[index] || !currentValue[index][valueMember]));
    return React.createElement("div", {
      ...
      var columnItemClass = classNames("".concat(prefixCls, "__stack-column-item"), _defineProperty({}, "".concat(prefixCls, "__stack-column-item--active"), isActive));
