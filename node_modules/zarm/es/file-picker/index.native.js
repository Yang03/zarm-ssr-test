...
function (_PureComponent) {
  ...
  _createClass(FilePicker, [{
    ...
    value: function render() {
      ...
      var content = disabled ? React.createElement(View, null, children) : React.createElement(TouchableOpacity, {
        onPress: this.handleShowCameraRoll
      }, children);
      var cameraRollPicker = React.createElement(Modal, {
        visible: isShowRoll,
        animationType: "slide",
        transparent: false,
      ...
      }, React.createElement(NavBar, null), React.createElement(CameraRollPicker, _extends({}, cameraRollOptions, {
        assetType: assetType,
        maximum: maximum,
