...
function (_PureComponent) {
  ...
  _createClass(Button, [{
    ...
    value: function render() {
      ...
      var iconRender = loading ? React.createElement(ActivityIndicator, {
        animating: true,
        style: iconStyle,
        size: "small"
      }) : icon;
      var contentRender = React.createElement(View, {
        style: styles.container
      }, iconRender, isValidElement(children) ? children : React.createElement(Text, {
        style: textStyle
      }, children));
      ...
      return ghost ? React.createElement(TouchableOpacity, wrapperProps, contentRender) : React.createElement(TouchableHighlight, _extends({}, wrapperProps, {
