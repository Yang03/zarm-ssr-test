...
var components = {
  ...
  button_primary_active_color: "".concat(Color('#fff').alpha(0.4)),
  ...
  button_danger_active_color: "".concat(Color('#fff').alpha(0.4)),
...
export default _objectSpread({}, base, {}, components);