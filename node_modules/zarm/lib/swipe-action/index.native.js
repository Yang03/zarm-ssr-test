...
var styles = _reactNative.StyleSheet.create(_index.default);

var SwipeAction =
/*#__PURE__*/
function (_PureComponent) {
  (0, _inherits2.default)(SwipeAction, _PureComponent);

  function SwipeAction(props) {
    var _this;

    (0, _classCallCheck2.default)(this, SwipeAction);
    _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(SwipeAction).call(this, props));
    _this.isOpen = false;
    _this.touchEnd = true;
    ...
    _this.doTransition = function (_ref4) {
      ...
      _reactNative.Animated.timing(_this.offsetLeft, {
        toValue: offsetLeft,
        duration: animationDuration // useNativeDriver: true
    ...
    _this.renderButton = function (button, index) {
      return (0, _react.cloneElement)(button, {
        key: +index,
        styles: _objectSpread({}, button.props.styles, {}, _reactNative.StyleSheet.create({
          textStyle: _index.default.textStyle
        })),
    ...
    _this.offsetLeft = new _reactNative.Animated.Value(0);
  ...
  (0, _createClass2.default)(SwipeAction, [{
    ...
    value: function render() {
      ...
      return left || right ? _react.default.createElement(_reactNative.View, {
        style: styles.wrapper
      }, this.renderButtons(left, 'left'), this.renderButtons(right, 'right'), _react.default.createElement(_reactNative.Animated.View, (0, _extends2.default)({
