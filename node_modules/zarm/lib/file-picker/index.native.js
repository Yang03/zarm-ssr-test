...
function (_PureComponent) {
  ...
  function FilePicker() {
    ...
    _this = (0, _possibleConstructorReturn2.default)(this, (_getPrototypeOf2 = (0, _getPrototypeOf3.default)(FilePicker)).call.apply(_getPrototypeOf2, [this].concat(args)));
    _this.state = {
      isShowRoll: false,
      imageList: [],
      selectedImages: []
  ...
  (0, _createClass2.default)(FilePicker, [{
    ...
    value: function render() {
      ...
      var content = disabled ? _react.default.createElement(_reactNative.View, null, children) : _react.default.createElement(_reactNative.TouchableOpacity, {
        onPress: this.handleShowCameraRoll
      }, children);

      var cameraRollPicker = _react.default.createElement(_reactNative.Modal, {
        visible: isShowRoll,
        animationType: "slide",
        transparent: false,
      ...
      }, _react.default.createElement(_index.default, null), _react.default.createElement(_reactNativeCameraRollPicker.default, (0, _extends2.default)({}, cameraRollOptions, {
        assetType: assetType,
        maximum: maximum,
