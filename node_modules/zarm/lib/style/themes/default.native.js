...
var base = {
  // 主题色
  theme_default: '#e6e6e6',
  // 默认色
  theme_primary: '#00bc70',
  // 主色
  theme_success: '#00bc70',
  // 成功
  theme_warning: '#ec9131',
  // 警告
  theme_danger: '#ff5050' // 失败

}; // 主题色

base = _objectSpread({}, base, {
  // press状态色阶
  ...
  color_text: '#464646',
  // 基本
  color_text_inverse: '#fff',
  // 反色
  color_text_placeholder: '#a9a9a9',
  // 文本框提示
  color_text_disabled: '#bcbcbc',
  // 失效
  color_text_caption: '#909090',
  // 辅助描述
  color_link: '#108ee9',
  // 链接
  color_shadow: 'rgba(56, 56, 56, .15)',
  // 阴影色
  // 背景色
...
var components = {
  ...
  button_primary_active_color: "".concat((0, _color.default)('#fff').alpha(0.4)),
  ...
  button_danger_active_color: "".concat((0, _color.default)('#fff').alpha(0.4)),
  ...
  cell_background: '#fff',
  // 背景色
  cell_line_padding_left: 16,
  // 分隔线左边距
  cell_padding_h: 16,
  // 水平边内距
  cell_padding_v: 15,
  // 纵向边内距
  cell_title_color: base.color_text,
  // 标题文字颜色
  cell_title_font_size: 15,
  // 标题文字大小
  cell_title_line_height: 22,
  // 标题文字行高
  cell_description_color: base.color_text_caption,
  // 标题文字颜色
  cell_description_font_size: 15,
  // 描述文字大小
  cell_label_width: 100,
  // 表单label度
  cell_arrow_color: '#bcbcbc',
  // 箭头颜色
  cell_arrow_length: 10,
  // 箭头长度
  cell_arrow_border_width: 2,
  // 箭头粗细
  // Checkbox
  checkbox_size: 20,
  // Collapse
  ...
  message_arrow_length_lg: 10,
  // 箭头颜色
  message_arrow_border_width: 1,
  // 箭头粗细
  // Modal
...
var _default = _objectSpread({}, base, {}, components);
