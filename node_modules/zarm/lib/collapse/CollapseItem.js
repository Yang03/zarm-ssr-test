...
function (_PureComponent) {
  (0, _inherits2.default)(CollapseItem, _PureComponent);
  ...
  function CollapseItem() {
    ...
    _this = (0, _possibleConstructorReturn2.default)(this, (_getPrototypeOf2 = (0, _getPrototypeOf3.default)(CollapseItem)).call.apply(_getPrototypeOf2, [this].concat(args)));
    ...
    _this.getContentHeight = function (content) {
      var children = (0, _toConsumableArray2.default)(content.children);
  ...
  (0, _createClass2.default)(CollapseItem, [{
    ...
    value: function render() {
      ...
      var _this$props2 = this.props,
          ...
          rest = (0, _objectWithoutProperties2.default)(_this$props2, ["prefixCls", "title", "className", "disabled", "animated", "isActive", "children", "onChange"]);
      var active = this.state.active;
      var cls = (0, _classnames2.default)(prefixCls, className, (_classnames = {}, (0, _defineProperty2.default)(_classnames, "".concat(prefixCls, "--active"), active), (0, _defineProperty2.default)(_classnames, "".concat(prefixCls, "--disabled"), disabled), _classnames));
