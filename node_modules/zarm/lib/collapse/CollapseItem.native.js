...
var _default = _interopRequireDefault(require("../style/themes/default.native"));

var collapseStyles = _reactNative.StyleSheet.create(_index.default);
...
function (_PureComponent) {
  ...
  function CollapseItem(_props) {
    ...
    _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(CollapseItem).call(this, _props));
    _this.titleHeight = _default.default.collapse_height;
    _this.bodyHeight = 0;
    ...
    _this.animate = function () {
      ...
      _reactNative.Animated.parallel([_reactNative.Animated.timing(_this.state.height, {
        toValue: height,
        duration: duration
    ...
    _this.state = {
      ...
      height: new _reactNative.Animated.Value(_this.titleHeight),
  ...
  (0, _createClass2.default)(CollapseItem, [{
    ...
    value: function render() {
      ...
      }, title), _react.default.createElement(_reactNative.Animated.View, {
