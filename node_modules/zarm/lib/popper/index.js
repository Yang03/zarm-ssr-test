...
var customArrowOffsetFn = function customArrowOffsetFn(data) {
  var _data$placement$split = data.placement.split('-'),
      _data$placement$split2 = (0, _slicedToArray2.default)(_data$placement$split, 2),
  ...
  var arrowSize = (0, _dom.getOuterSizes)(arrow)[len];
...
function (_React$Component) {
  ...
  function Popper() {
    ...
    _this = (0, _possibleConstructorReturn2.default)(this, (_getPrototypeOf2 = (0, _getPrototypeOf3.default)(Popper)).call.apply(_getPrototypeOf2, [this].concat(args)));
    _this.popper = void 0;
    ...
    _this.handleOpen = function () {
      ...
      _this.popper = new _popper.default(reference, popperNode, {
        placement: _PropsType.directionMap[direction],
        modifiers: {
          preventOverflow: {
      ...
      _events.default.on(_this.popperNode, 'webkitAnimationEnd', _this.animationEnd);

      _events.default.on(_this.popperNode, 'animationend', _this.animationEnd);
    ...
    _this.handlePopperUpdate = function (data) {
      ...
      if (data.placement !== _this.state.direction) {
        _this.setState({
          direction: invertKeyValues(_PropsType.directionMap)[data.placement]
        });
      }
    };
    ...
    _this.handleEnter = function (event) {
      ...
      if (_react.default.isValidElement(children) && event.type === 'mouseover' && childrenProps.onMouseOver) {
    ...
    _this.handleLeave = function (event) {
      ...
      if (_react.default.isValidElement(children) && event.type === 'blur' && childrenProps.onBlur) {
        childrenProps.onBlur(event);
      }

      if (_react.default.isValidElement(children) && event.type === 'mouseleave' && childrenProps.onMouseLeave) {
  ...
  (0, _createClass2.default)(Popper, [{
    ...
    value: function componentWillUnmount() {
      if (this.popperNode) {
        _events.default.off(this.popperNode, 'webkitAnimationEnd', this.animationEnd);

        _events.default.off(this.popperNode, 'animationend', this.animationEnd);
      }
    ...
    value: function render() {
      ...
      var innerCls = (0, _classnames2.default)(className, prefixCls, "".concat(prefixCls, "--").concat(direction), (_classnames = {}, (0, _defineProperty2.default)(_classnames, "".concat(prefixCls, "--hidden"), animationState === 'leave'), (0, _defineProperty2.default)(_classnames, transitionName, isPending), _classnames));
      var child = _react.default.isValidElement(children) ? children : _react.default.createElement("span", null, children);
      ...
      var toolTip = _react.default.createElement(_clickOutside.default, {
      ...
      }, content), hasArrow && _react.default.createElement("span", {
      ...
      return _react.default.createElement(_react.default.Fragment, null, mounted && (0, _reactDom.createPortal)(toolTip, this.mountContainer()), _react.default.cloneElement(child, _objectSpread({
        ref: function ref(node) {
          // eslint-disable-next-line react/no-find-dom-node
          _this2.reference = _reactDom.default.findDOMNode(node);
        }
      }, childrenProps)));
    }
  }], [{
