...
var _keyboardPicker = _interopRequireDefault(require("../keyboard-picker"));
...
function (_Component) {
  ...
  (0, _createClass2.default)(InputNumber, [{
    ...
    value: function componentDidMount() {
      ...
      _events.default.on(document.body, 'click', this.onMaskClick);
    ...
    value: function componentWillUnmount() {
      _events.default.off(document.body, 'click', this.onMaskClick);
    }
  }, {
    key: "render",
    value: function render() {
      ...
      var cls = (0, _classnames2.default)(prefixCls, "".concat(prefixCls, "--").concat(type), className, (_classnames = {}, (0, _defineProperty2.default)(_classnames, "".concat(prefixCls, "--disabled"), disabled), (0, _defineProperty2.default)(_classnames, "".concat(prefixCls, "--focus"), visible), (0, _defineProperty2.default)(_classnames, "".concat(prefixCls, "--clearable"), showClearIcon), (0, _defineProperty2.default)(_classnames, "".concat(prefixCls, "--readonly"), readOnly), _classnames));

      var renderInput = _react.default.createElement("div", {
        className: "".concat(prefixCls, "__content")
      }, !value && !readOnly && _react.default.createElement("div", {
        ...
        value: value,
        disabled: disabled
      }), _react.default.createElement(_keyboardPicker.default, {
        ref: function ref(ele) {
          _this2.picker = ele;
        },
        visible: visible,
      ...
      var renderText = _react.default.createElement("div", {
        className: "".concat(prefixCls, "__content")
      }, value);

      var renderClearIcon = showClearIcon && _react.default.createElement(_icon.default, {
