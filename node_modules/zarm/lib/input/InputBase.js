  ...
  (0, _createClass2.default)(InputBase, [{
    ...
    value: function render() {
      ...
      var _this$props3 = this.props,
          ...
          rest = (0, _objectWithoutProperties2.default)(_this$props3, ["prefixCls", "className", "disabled", "clearable", "readOnly", "type", "onClear"]);
      var _this$state = this.state,
          value = _this$state.value,
          focused = _this$state.focused;
      var showClearIcon = clearable && 'value' in this.props && 'onChange' in this.props;
      var cls = (0, _classnames2.default)(prefixCls, className, (_classnames = {}, (0, _defineProperty2.default)(_classnames, "".concat(prefixCls, "--disabled"), disabled), (0, _defineProperty2.default)(_classnames, "".concat(prefixCls, "--focus"), focused && value && value.length > 0), (0, _defineProperty2.default)(_classnames, "".concat(prefixCls, "--clearable"), showClearIcon), (0, _defineProperty2.default)(_classnames, "".concat(prefixCls, "--readonly"), readOnly), _classnames));

      var renderInput = _react.default.createElement("input", (0, _extends2.default)({}, rest, {
