...
function (_PureComponent) {
  ...
  function InputTextarea(props) {
    ...
    _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(InputTextarea).call(this, props));
    _this.input = void 0;
  ...
  (0, _createClass2.default)(InputTextarea, [{
    ...
    value: function render() {
      ...
      var textLengthRender = showLength && maxLength && _react.default.createElement("div", {
        className: "".concat(prefixCls, "__length")
      }, "".concat(length, "/").concat(maxLength));

      var renderInput = _react.default.createElement("textarea", (0, _extends2.default)({}, rest, {
