...
function (_PureComponent) {
  ...
  function Keyboard() {
    ...
    _this = (0, _possibleConstructorReturn2.default)(this, (_getPrototypeOf2 = (0, _getPrototypeOf3.default)(Keyboard)).call.apply(_getPrototypeOf2, [this].concat(args)));
    _this.longPressTimer = void 0;

    _this.onLongPressIn = function (key) {
    ...
    _this.onLongPressOut = function (e) {
      e.preventDefault();
    ...
    _this.renderKey = function (text, index) {
      ...
      var keyCls = (0, _classnames2.default)("".concat(prefixCls, "__item"), (0, _defineProperty2.default)({}, "".concat(prefixCls, "__item--disabled"), text.length === 0));
      ...
      }, text === 'close' ? _react.default.createElement(_icon.default, {
        type: "keyboard",
        size: "lg"
      }) : text);
    };
  ...
  (0, _createClass2.default)(Keyboard, [{
    ...
    value: function render() {
      ...
      }, this.getKeys().map(this.renderKey)), _react.default.createElement("div", {
