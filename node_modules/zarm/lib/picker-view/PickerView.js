...
function (_Component) {
  ...
  function PickerView() {
    ...
    _this = (0, _possibleConstructorReturn2.default)(this, (_getPrototypeOf2 = (0, _getPrototypeOf3.default)(PickerView)).call.apply(_getPrototypeOf2, [this].concat(args)));
    ...
    _this.renderWheel = function () {
      ...
      return dataSource.map(function (item, index) {
        return _react.default.createElement(_wheel.default, {
          key: +index,
          dataSource: item,
          value: value[index],
          valueMember: valueMember,
          ...
          onTransition: function onTransition(isScrolling) {
            _this.onTransition(isScrolling);
          }
        });
      });
    };
  ...
  (0, _createClass2.default)(PickerView, [{
    ...
    value: function render() {
      ...
      }, this.renderWheel()), _react.default.createElement("div", {
    ...
    value: function getDerivedStateFromProps(props, state) {
      if (!(0, _isEqual.default)((0, _removeFnFromProps.default)(props, ['onChange', 'onTransition']), (0, _removeFnFromProps.default)(state.prevProps, ['onChange', 'onTransition']))) {
