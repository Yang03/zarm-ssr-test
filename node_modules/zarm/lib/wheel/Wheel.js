...
var getValue = function getValue(props, defaultValue) {
  ...
  if ((0, _validate.isArray)(props.dataSource) && props.dataSource[0]) {
...
/*#__PURE__*/
function (_Component) {
  (0, _inherits2.default)(Wheel, _Component);
  ...
  function Wheel() {
    ...
    _this = (0, _possibleConstructorReturn2.default)(this, (_getPrototypeOf2 = (0, _getPrototypeOf3.default)(Wheel)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  (0, _createClass2.default)(Wheel, [{
    ...
    value: function componentDidMount() {
      ...
      this.BScroll = new _betterScroll.default(this.wrapper, {
        wheel: {
    ...
    value: function render() {
      ...
      var items = dataSource.map(function (item, index) {
        ...
        var itemCls = (0, _classnames2.default)("".concat(prefixCls, "__item"), (_classnames = {}, (0, _defineProperty2.default)(_classnames, "".concat(prefixCls, "__item--selected"), value === item[valueMember]), (0, _defineProperty2.default)(_classnames, "".concat(prefixCls, "__item--disabled"), disabled), _classnames));
        return _react.default.createElement("div", {
          key: +index,
          className: itemCls
        }, itemRender(item));
      });
      var rollerCls = (0, _classnames2.default)(prefixCls, className);
      return _react.default.createElement("div", {
        className: rollerCls,
