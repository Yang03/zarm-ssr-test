...
function (_PureComponent) {
  (0, _inherits2.default)(BackToTop, _PureComponent);
  ...
  function BackToTop() {
    ...
    (0, _classCallCheck2.default)(this, BackToTop);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = (0, _possibleConstructorReturn2.default)(this, (_getPrototypeOf2 = (0, _getPrototypeOf3.default)(BackToTop)).call.apply(_getPrototypeOf2, [this].concat(args)));
    _this.state = {
      visible: false
    };
    _this.timer = void 0;
    ...
    _this.scrollToTop = function (e) {
      ...
      if (speed === 0 || speed === Infinity) {
        (0, _dom.scrollTo)(container, 0, 0, 0);
        return;
      }

      var x = _this.props.speed;
      (0, _dom.scrollTo)(container, 0, 0, _this.scrollTop / (x / 10 * 1000));
    };

    return _this;
  }

  (0, _createClass2.default)(BackToTop, [{
    ...
    key: "parent",
    get: function get() {
      if (!_dom.canUseDOM || this.container === window) {
    ...
    get: function get() {
      ...
      return (0, _reactDom.createPortal)(_react.default.createElement(_react.default.Fragment, null, _react.default.createElement("div", {
        className: prefixCls,
        style: containerStyle,
        onClick: this.scrollToTop
      }, children), _react.default.createElement(_scroller.default, {
    ...
    get: function get() {
      ...
      if (!this.portalContainer) {
        ...
        container.className = (0, _classnames.default)("".concat(prefixCls, "-container"), className);
...
BackToTop.defaultProps = {
  ...
  speed: 100,
  visibleDistance: 400,
  scrollContainer: _dom.canUseDOM ? window : undefined
};