...
function (_PureComponent) {
  ...
  (0, _createClass2.default)(Loading, [{
    ...
    value: function render() {
      ...
      }, content || _react.default.createElement(_activityIndicator.default, {
        type: "spinner",
        size: "lg"
      }))));
    }
...
Loading.show = function (content) {
  ...
  if (!Loading.zarmLoading) {
    ...
    Loading.loadingContainer = content ? (0, _dom.getMountContainer)(content.mountContainer) : (0, _dom.getMountContainer)();
    Loading.loadingContainer.appendChild(Loading.zarmLoading);
  }

  if (Loading.zarmLoading) {
    var props = _objectSpread({}, Loading.defaultProps, {}, content, {}, {
      visible: true,
      mountContainer: Loading.zarmLoading
    });

    _reactDom.default.render(_react.default.createElement(Loading, props), Loading.zarmLoading);
  }
};
...
Loading.unmountNode = function () {
  ...
  if (zarmLoading) {
    _reactDom.default.render(_react.default.createElement(_react.default.Fragment, null), zarmLoading);
