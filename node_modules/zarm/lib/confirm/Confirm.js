...
function (_PureComponent) {
  (0, _inherits2.default)(Confirm, _PureComponent);
  ...
  (0, _createClass2.default)(Confirm, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          others = (0, _objectWithoutProperties2.default)(_this$props, ["prefixCls", "className", "content", "okText", "cancelText", "onOk", "onCancel", "locale"]);
      var cls = (0, _classnames.default)(prefixCls, className);
      return _react.default.createElement(_modal.default, (0, _extends2.default)({
        className: cls
      }, others, {
        footer: _react.default.createElement(_react.default.Fragment, null, _react.default.createElement("button", {
          type: "button",
          className: "".concat(prefixCls, "__button"),
          onClick: onCancel
        }, cancelText || locale.cancelText), _react.default.createElement("button", {
          type: "button",
