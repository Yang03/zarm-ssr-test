...
function (_Component) {
  ...
  function CalendarMonthView(_props) {
    ...
    _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(CalendarMonthView).call(this, _props));
    _this.min = void 0;
    _this.max = void 0;
    _this.lastIn = false;
    ...
    _this.checkRefresh = function (props) {
      ...
      if (value.length > 0) {
        var currMonth = _date.default.cloneDate(dateMonth, 'dd', 1);

        var min1 = _date.default.cloneDate(value[0], 'dd', 1);

        var max1 = _date.default.cloneDate(value[value.length - 1], 'dd', 1);
    ...
    _this.renderDay = function (day, year, month, firstDay) {
      ...
      if ((0, _typeof2.default)(txt) === 'object') {
        if (!(0, _react.isValidElement)(txt)) {
      ...
      }, txt && _react.default.createElement("div", {
  ...
  (0, _createClass2.default)(CalendarMonthView, [{
    ...
    value: function render() {
      ...
      }, _react.default.createElement("ul", null, this.renderContent(year, month)));
    }
  }], [{
