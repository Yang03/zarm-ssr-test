...
var _renderWithText = require("../utils/renderWithText.native");
...
var cellStyles = _reactNative.StyleSheet.create(_index.default);
  ...
  (0, _createClass2.default)(Cell, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          others = (0, _objectWithoutProperties2.default)(_this$props, ["hasArrow", "icon", "title", "description", "help", "style", "styles", "onClick", "children"]);
      ...
      var iconRender = icon && _react.default.createElement(_reactNative.View, {
        style: styles.iconStyle
      }, icon);

      var arrowRender = hasArrow && _react.default.createElement(_reactNative.View, {
        style: styles.arrowStyle
      });

      var cellRender = _react.default.createElement(_reactNative.View, {
        style: wrapperStyle
      ...
      }, iconRender, _react.default.createElement(_reactNative.View, {
        style: styles.bodyStyle
      }, _react.default.createElement(_renderWithText.RenderWithText, {
        component: title,
      ...
      }), arrowRender)), _react.default.createElement(_renderWithText.RenderWithText, {
        component: help,
      ...
      return onClick ? _react.default.createElement(_reactNative.TouchableHighlight, wrapperProps, cellRender) : cellRender;
    }
  }]);
  return Cell;
