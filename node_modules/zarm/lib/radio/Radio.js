...
function (_PureComponent) {
  ...
  (0, _createClass2.default)(Radio, [{
    ...
    value: function render() {
      ...
      var inputRender = _react.default.createElement("input", {
        id: id,
        type: "radio",
      ...
      var radioRender = _react.default.createElement("span", (0, _extends2.default)({
        className: cls
      ...
      if (type === 'cell') {
        return _react.default.createElement(_cell.default, (0, _extends2.default)({
          disabled: disabled,
          className: className,
