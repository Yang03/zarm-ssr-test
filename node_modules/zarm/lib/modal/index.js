...
function modalType(props, type) {
  ...
  function render(visible) {
    var runTimeLocale = (0, _LocaleProvider.getRunTimeLocale)();

    if (type === 'alert') {
      var _props = props;

      if (runTimeLocale && runTimeLocale.Alert) {
        _props = _objectSpread({}, props, {
          className: '',
          locale: runTimeLocale.Alert
        });
      }

      _reactDom.default.render(_react.default.createElement(_Alert.default, (0, _extends2.default)({}, _props, {
      ...
      if (runTimeLocale && runTimeLocale.Confirm) {
        _props2 = _objectSpread({}, props, {
          className: '',
          locale: runTimeLocale.Confirm
        });
      }

      _reactDom.default.render(_react.default.createElement(_Confirm.default, (0, _extends2.default)({}, _props2, {
        mountContainer: container,
        onCancel: function onCancel() {
          _onCancel(render);
        },
